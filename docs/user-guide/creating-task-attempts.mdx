...
<Info>
For more details about how subtasks work with task attempts, see [Creating Subtasks](/user-guide/subtasks).
</Info>
...
For detailed task management after execution, including development server controls, git operations, and monitoring features, see [Task Details Full Screen Mode](/user-guide/task-details-full-screen).
