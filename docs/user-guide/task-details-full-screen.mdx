...
#### New Attempts
Create additional attempts for the same task when:
- Previous approaches didn't work as expected
- You want to try a different implementation strategy
- Testing alternative solutions
- Attempting the task with a different coding agent

**Access Methods:**
- **New Attempt** button in the current attempt toolbar
- **Create Attempt** form for tasks without attempts
...
Learn more in [Creating Tasks](/user-guide/creating-tasks).
...
Learn more in [Reviewing Code Changes](/user-guide/reviewing-code-changes).
...
- [Creating Task Attempts](/user-guide/creating-task-attempts) - Learn about task attempt lifecycle
- [Reviewing Code Changes](/user-guide/reviewing-code-changes) - Deep dive into diff analysis  
- [Creating Tasks](/user-guide/creating-tasks) - Task creation and management
- [Agent Configurations](/user-guide/agent-configurations) - Customize AI agent behavior
