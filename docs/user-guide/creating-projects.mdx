...
<Frame>
<img src="/images/vk-create-project.jpeg" alt="Create project dialog showing options to create from existing git repository or blank project" />
</Frame>

When the Create Project button is pressed, you have two options: either create from an existing git repository or create from a blank project. If you choose the former, we will search your file system and show you a list of git repositories sorted by recent activity. If you choose the latter option to 'Create Blank Project', it will create a git repo.

Each project represents a git repo and after creation, you can configure it with its own setup scripts, dev server scripts, and other settings.
...
From project settings, you can also configure project-specific task templates. For more details about this feature, see the [project task templates section](/user-guide/creating-task-templates#project-task-templates).
