...
- **Development controls**: Start, stop, and manage your development server from the toolbar

<Frame>
<!-- Placeholder for preview tab screenshot -->
<img src="/images/vk-preview.png" alt="Preview tab showing embedded web application with development controls" />
</Frame>
