...
For detailed guidance on handling rebase conflicts, see [Resolving Merge Conflicts](/core-features/resolving-merge-conflicts).
...
- [Resolving Merge Conflicts](/core-features/resolving-merge-conflicts) - Handle rebase conflicts and merge issues
