...
<Info>
For detailed information about when and why to create new attempts, see [Creating Task Attempts](/user-guide/creating-task-attempts).
</Info>
...
Learn more in [Creating Subtasks](/user-guide/subtasks).
...
- [Agent Configurations](/user-guide/agent-configurations) - Customise AI agent behaviour
