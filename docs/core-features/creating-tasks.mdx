...
<Note>
For detailed task management after execution, see [Task Details Full Screen Mode](/user-guide/task-details-full-screen). To understand when you might need multiple attempts, see [Creating Task Attempts](/user-guide/creating-task-attempts).
</Note>
...
<Tip>
For detailed setup instructions and examples, see the [Vibe Kanban MCP Server](/user-guide/vibe-kanban-mcp-server) documentation.
</Tip>
