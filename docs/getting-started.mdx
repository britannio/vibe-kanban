...
2. [Complete the onboarding steps](/getting-started/onboarding) in the application

3. [Configure Global Settings](/getting-started/global-settings) to personalize your experience

4. [Create a project](/user-guide/creating-projects)

5. [Create tasks](/user-guide/creating-tasks)

6. Optional: [Set up MCP integration](/user-guide/vibe-kanban-mcp-server) to streamline task creation with coding agents
