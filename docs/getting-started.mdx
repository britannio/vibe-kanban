...
<Step title="Add tasks">
  Start tracking your work by [creating tasks](/user-guide/creating-tasks) within your project.
</Step>

<Step title="Optional: Configure GitHub integration">
  Connect to GitHub in [Settings](/global-settings) to enable branch management and pull request creation.
</Step>
