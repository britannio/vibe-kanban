...
[Create projects](/user-guide/creating-projects) from existing Git repositories to enable GitHub features.
</Step>

<Step title="Work on Tasks">
[Create task attempts](/user-guide/creating-task-attempts) to start developing in isolated branches.
</Step>
...
- [Learn about creating projects](/user-guide/creating-projects)
- [Set up task attempts for feature development](/user-guide/creating-task-attempts) 
- [Review code changes before committing](/user-guide/reviewing-code-changes)
