...
<Note>
This page covers configuring MCP servers **within** Vibe Kanban for your coding agents. For connecting external MCP clients to Vibe Kanban's MCP server, see the [Vibe Kanban MCP Server](/user-guide/vibe-kanban-mcp-server) guide.
</Note>
...
- Explore the [Agent Configurations](/user-guide/agent-configurations) guide for advanced agent setup
- Learn about [Creating Tasks](/user-guide/creating-tasks) with enhanced MCP capabilities
