...
<Frame>
<img src="/images/screenshot-global-settings.png" alt="Vibe Kanban global settings page showing theme options, agent configuration, and GitHub integration settings" />
</Frame>
...
1. **Select an agent** (e.g., CLAUDE_CODE, GEMINI, CODEX)
...
<Card title="Learn more about task templates" icon="template" href="/user-guide/creating-task-templates">
  Complete guide to creating and managing task templates
</Card>

## Agent Settings (Profiles & Variants)

Define and customise agent variants under **Settings → Agents**. Variants let you maintain multiple configurations for the same agent (for example, a CLAUDE_CODE "PLAN" variant).

<Card title="Agent Profiles & Variants" icon="user-cog" href="/user-guide/agent-configurations">
